## OpenAPI Auto-Generated [http-client](https://www.stackage.org/lts-10.0/package/http-client-0.5.7.1) Bindings to `Netatmo`

The library in `lib` provides auto-generated-from-OpenAPI [http-client](https://www.stackage.org/lts-10.0/package/http-client-0.5.7.1) bindings to the Netatmo API.
...
| baseModule                      | Set the base module namespace                                                                                                 |          | Netatmo                      |
| cabalPackage                    | Set the cabal package name, which consists of one or more alphanumeric words separated by hyphens                             |          | netatmo                    |
...
| configType                      | Set the name of the type used for configuration                                                                               |          | NetatmoConfig                      |
...
| requestType                     | Set the name of the type used to generate requests                                                                            |          | NetatmoRequest                     |
...
| MODULE              | NOTES                                               |
| ------------------- | --------------------------------------------------- |
| Netatmo.Client    | use the "dispatch" functions to send requests       |
| Netatmo.Core      | core functions, config and request types            |
| Netatmo.API       | construct api requests                              |
| Netatmo.Model     | describes api models                                |
| Netatmo.MimeTypes | encoding/decoding MIME types (content-types/accept) |
| Netatmo.ModelLens | lenses for model fields                             |
| Netatmo.Logging   | logging functions and utils                         |
