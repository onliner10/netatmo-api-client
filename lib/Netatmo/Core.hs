...
module Netatmo.Core where

import Netatmo.MimeTypes
import Netatmo.Logging
...
-- |
data NetatmoConfig = NetatmoConfig
...
-- | display the config
instance P.Show NetatmoConfig where
  show c =
    T.printf
...
-- | constructs a default NetatmoConfig
--
-- configHost:
--
...
-- @"netatmo/0.1.0.0"@
--
newConfig :: IO NetatmoConfig
newConfig = do
    logCxt <- initLogContext
    return $ NetatmoConfig
        { configHost = "https://api.netatmo.net/api"
        , configUserAgent = "netatmo/0.1.0.0"
...
addAuthMethod :: AuthMethod auth => NetatmoConfig -> auth -> NetatmoConfig
addAuthMethod config@NetatmoConfig {configAuthMethods = as} a =
  config { configAuthMethods = AnyAuthMethod a : as}

-- | updates the config to use stdout logging
withStdoutLogging :: NetatmoConfig -> IO NetatmoConfig
...
withStderrLogging :: NetatmoConfig -> IO NetatmoConfig
...
withNoLogging :: NetatmoConfig -> NetatmoConfig
...
data NetatmoRequest req contentType res accept = NetatmoRequest
  { rMethod  :: NH.Method   -- ^ Method of NetatmoRequest
  , rUrlPath :: [BCL.ByteString] -- ^ Endpoint of NetatmoRequest
  , rParams   :: Params -- ^ params of NetatmoRequest
  , rAuthTypes :: [P.TypeRep] -- ^ types of auth methods
  }
  deriving (P.Show)

-- | 'rMethod' Lens
rMethodL :: Lens_' (NetatmoRequest req contentType res accept) NH.Method
rMethodL f NetatmoRequest{..} = (\rMethod -> NetatmoRequest { rMethod, ..} ) <$> f rMethod
{-# INLINE rMethodL #-}

-- | 'rUrlPath' Lens
rUrlPathL :: Lens_' (NetatmoRequest req contentType res accept) [BCL.ByteString]
rUrlPathL f NetatmoRequest{..} = (\rUrlPath -> NetatmoRequest { rUrlPath, ..} ) <$> f rUrlPath
{-# INLINE rUrlPathL #-}

-- | 'rParams' Lens
rParamsL :: Lens_' (NetatmoRequest req contentType res accept) Params
rParamsL f NetatmoRequest{..} = (\rParams -> NetatmoRequest { rParams, ..} ) <$> f rParams
{-# INLINE rParamsL #-}

-- | 'rParams' Lens
rAuthTypesL :: Lens_' (NetatmoRequest req contentType res accept) [P.TypeRep]
rAuthTypesL f NetatmoRequest{..} = (\rAuthTypes -> NetatmoRequest { rAuthTypes, ..} ) <$> f rAuthTypes
{-# INLINE rAuthTypesL #-}
...
class HasBodyParam req param where
  setBodyParam :: forall contentType res accept. (Consumes req contentType, MimeRender contentType param) => NetatmoRequest req contentType res accept -> param -> NetatmoRequest req contentType res accept
  setBodyParam req xs =
...
class HasOptionalParam req param where
  ...
  applyOptionalParam :: NetatmoRequest req contentType res accept -> param -> NetatmoRequest req contentType res accept
  applyOptionalParam = (-&-)
  {-# INLINE applyOptionalParam #-}

  -- | infix operator \/ alias for 'addOptionalParam'
  (-&-) :: NetatmoRequest req contentType res accept -> param -> NetatmoRequest req contentType res accept
  (-&-) = applyOptionalParam
  {-# INLINE (-&-) #-}
...
-- ** NetatmoRequest Utils

_mkRequest :: NH.Method -- ^ Method
          -> [BCL.ByteString] -- ^ Endpoint
          -> NetatmoRequest req contentType res accept -- ^ req: Request Type, res: Response Type
_mkRequest m u = NetatmoRequest m u _mkParams []

_mkParams :: Params
_mkParams = Params [] [] ParamBodyNone

setHeader ::
     NetatmoRequest req contentType res accept
  -> [NH.Header]
  -> NetatmoRequest req contentType res accept
...
removeHeader :: NetatmoRequest req contentType res accept -> [NH.HeaderName] -> NetatmoRequest req contentType res accept
...
_setContentTypeHeader :: forall req contentType res accept. MimeType contentType => NetatmoRequest req contentType res accept -> NetatmoRequest req contentType res accept
_setContentTypeHeader req =
    case mimeType (P.Proxy :: P.Proxy contentType) of
        Just m -> req `setHeader` [("content-type", BC.pack $ P.show m)]
        Nothing -> req `removeHeader` ["content-type"]

_setAcceptHeader :: forall req contentType res accept. MimeType accept => NetatmoRequest req contentType res accept -> NetatmoRequest req contentType res accept
...
addForm :: NetatmoRequest req contentType res accept -> WH.Form -> NetatmoRequest req contentType res accept
addForm req newform =
...
_addMultiFormPart :: NetatmoRequest req contentType res accept -> NH.Part -> NetatmoRequest req contentType res accept
...
_setBodyBS :: NetatmoRequest req contentType res accept -> B.ByteString -> NetatmoRequest req contentType res accept
_setBodyBS req body =
    req & L.set (rParamsL . paramsBodyL) (ParamBodyB body)

_setBodyLBS :: NetatmoRequest req contentType res accept -> BL.ByteString -> NetatmoRequest req contentType res accept
_setBodyLBS req body =
    req & L.set (rParamsL . paramsBodyL) (ParamBodyBL body)

_hasAuthType :: AuthMethod authMethod => NetatmoRequest req contentType res accept -> P.Proxy authMethod -> NetatmoRequest req contentType res accept
...
class P.Typeable a =>
  ...
  applyAuthMethod
    ...
    -> a
    -> NetatmoRequest req contentType res accept
    -> IO (NetatmoRequest req contentType res accept)
...
_applyAuthMethods
  ...
  -> NetatmoConfig
  -> IO (NetatmoRequest req contentType res accept)
_applyAuthMethods req config@(NetatmoConfig {configAuthMethods = as}) =
  foldlM go req as
  where
