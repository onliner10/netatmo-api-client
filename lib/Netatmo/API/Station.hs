...
module Netatmo.API.Station where
...
getmeasure
  ...
  -> NetatmoRequest Getmeasure MimeNoContent NAMeasureResponse MimeJSON
getmeasure (DeviceId deviceId) (Scale scale) (ParamType _type) =
...
instance HasOptionalParam Getmeasure ModuleId where
...
instance HasOptionalParam Getmeasure DateBegin where
...
instance HasOptionalParam Getmeasure DateEnd where
...
instance HasOptionalParam Getmeasure Limit where
...
instance HasOptionalParam Getmeasure Optimize where
...
instance HasOptionalParam Getmeasure RealTime where
  applyOptionalParam req (RealTime xs) =
    req `addQuery` toQuery ("real_time", Just xs)
-- | @application/json@
instance Produces Getmeasure MimeJSON
...
-- 
getstationsdata
  :: NetatmoRequest Getstationsdata MimeNoContent NAStationDataResponse MimeJSON
getstationsdata =
  _mkRequest "GET" ["/getstationsdata"]
    `_hasAuthType` (P.Proxy :: P.Proxy AuthOAuthCodeOauth)
    `_hasAuthType` (P.Proxy :: P.Proxy AuthOAuthPasswordOauth)
...
instance HasOptionalParam Getstationsdata DeviceId where
  applyOptionalParam req (DeviceId xs) =
    req `addQuery` toQuery ("device_id", Just xs)
-- | @application/json@
instance Produces Getstationsdata MimeJSON
